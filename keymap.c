...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT_split_3x6_3(KC_GRV, KC_NO, KC_LBRC, KC_UNDS, KC_RBRC, KC_COMM, KC_CIRC, KC_7, KC_8, KC_9, KC_EQL, KC_NO, DT_UP, LCTL_T(KC_BSLS), KC_LPRN, KC_MINS, SC_RSPC, KC_DOT, KC_PLUS, RSFT_T(KC_4), KC_5, KC_6, KC_SCLN, KC_BSLS, DT_DOWN, DT_PRNT, KC_LCBR, KC_ASTR, KC_RCBR, KC_PERC, KC_DLR, KC_1, KC_2, KC_3, KC_SLSH, KC_NO, KC_BSPC, KC_TAB, KC_ENT, KC_SPC, KC_0, KC_BSPC),
	...
	[3] = LAYOUT_split_3x6_3(KC_F14, KC_F15, KC_DEL, KC_UP, KC_TAB, KC_EQL, KC_MPRV, KC_MPLY, KC_MNXT, 0x7F, 0x81, 0x80, KC_TRNS, LCTL_T(KC_A), KC_LEFT, LT(4,KC_DOWN), LSFT_T(KC_RGHT), KC_MINS, RGB_TOG, KC_RSFT, KC_RGUI, KC_RALT, KC_RCTL, KC_NO, KC_TRNS, LGUI(KC_Z), LGUI(KC_X), LGUI(KC_C), LGUI(KC_V), KC_NO, RGB_RMOD, RGB_MOD, RGB_HUD, RGB_HUI, RGB_VAD, KC_TRNS, KC_BSPC, KC_SPC, KC_ENT, KC_TRNS, KC_TRNS, KC_TRNS),
