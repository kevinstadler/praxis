...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_split_3x6_3(KC_GRV, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_BSLS, KC_ESC, LCTL_T(KC_A), LALT_T(KC_S), LT(4,KC_D), LSFT_T(KC_F), KC_G, KC_H, RSFT_T(KC_J), LT(4,KC_K), RALT_T(KC_L), RCTL_T(KC_SCLN), KC_QUOT, TT(3), KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, TT(3), KC_BSPC, LT(1,KC_TAB), LT(2,KC_ENT), KC_ENT, LT(2,KC_SPC), KC_BSPC),
	[1] = LAYOUT_split_3x6_3(KC_GRV, KC_NO, KC_LBRC, KC_UNDS, KC_RBRC, KC_COMM, KC_CIRC, KC_7, KC_8, KC_9, KC_EQL, KC_NO, DT_UP, LCTL_T(KC_BSLS), KC_LPRN, KC_MINS, SC_RSPC, KC_DOT, KC_PLUS, RSFT_T(KC_4), KC_5, KC_6, KC_SCLN, KC_BSLS, DT_DOWN, DT_PRNT, KC_LCBR, KC_ASTR, KC_RCBR, KC_NO, KC_DLR, KC_1, KC_2, KC_3, KC_SLSH, KC_NO, KC_BSPC, KC_TAB, KC_ENT, KC_SPC, KC_0, KC_BSPC),
	...
	[3] = LAYOUT_split_3x6_3(KC_F14, KC_F15, KC_DEL, KC_UP, KC_TAB, KC_EQL, KC_MPRV, KC_MPLY, KC_MNXT, 0x7F, 0x81, 0x80, KC_TRNS, LCTL_T(KC_A), KC_LEFT, LT(4,KC_DOWN), LSFT_T(KC_RGHT), KC_MINS, RGB_TOG, KC_RSFT, KC_RGUI, KC_RALT, KC_RCTL, KC_NO, KC_TRNS, KC_Z, KC_X, KC_C, KC_V, KC_NO, RGB_RMOD, RGB_MOD, RGB_HUD, RGB_HUI, RGB_VAD, KC_TRNS, KC_BSPC, LGUI_T(KC_SPC), KC_ENT, KC_TRNS, KC_TRNS, KC_TRNS),
	...
	[5] = LAYOUT_split_3x6_3(KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO)
};
